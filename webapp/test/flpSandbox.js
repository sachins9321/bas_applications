		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo APP",
									"targetURL": "#myapppro01comandlineapptemp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myapppro01comandlineapptemp-display": {
								"semanticObject": "myapppro01comandlineapptemp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=my.app.pro01comandlineapptemp",
									"url": sap.ui.require.toUrl("my/app/pro01comandlineapptemp")
								}
							}
						}
					}
